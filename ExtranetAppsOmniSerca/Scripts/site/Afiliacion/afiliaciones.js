...
app.controller('afiliacionesCtrl', function ($scope, $http, $window) {
    ...
    $http({
        method: 'GET',
        url: '/Afiliaciones/GetAccesoDesc'
    ...
    $scope.GetVendedores = function () {
        ...
        $http({
            method: 'GET',
            url: '/Afiliaciones/GetVendedores'
        }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: '/afiliaciones/GetLocalidades'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: '/afiliaciones/GetCondicionIVAs'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: '/afiliaciones/GetFormaDePagos'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: '/afiliaciones/GetTipoDeTarjetas'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: '/afiliaciones/GetTipoCuentas'
    }).then(function successCallback(response) {
    ...
    $scope.GetData = function () {
        ...
        $http({
            method: 'GET',
            url: '/afiliaciones/GetClientesSegunEstado?pTipoCliente=' + $scope.filter.tipoCliente + '&pDescripcion=' + $scope.filter.descripcion + '&pUsuarioId=' + usId,
        }).then(function successCallback(response) {
    ...
    $scope.data.clientes.settings =
    {
        ...
        cellclick: function (event) {
            ...
            if (columnIndex == 9 && args.row.bounddata.Estado == 3) { //$scope.acceso == "Administrador" &&
    ...
    $scope.GetContrato = function (clienteId) {
        checkSessionStorage();
        window.open('/afiliaciones/GetContrato?pClienteId=' + clienteId, '_black');
    }
    ...
    $scope.GetSolicitudDigitalizada = function (clienteId) {
        ...
        $http({
            method: 'GET',
            url: '/afiliaciones/GetSolicitudDigitalizada?pClienteId=' + clienteId
        }).then(function successCallback(response) {
    ...
    $scope.guardarFirma = function () {
         ...
         if ($scope.data.solicitudDigitalizada.EntidadCliente.ClienteId != 0) {
            ...
            $http.post('/afiliaciones/GuardarFirma', { pFirma: url, pCli: $scope.data.solicitudDigitalizada.EntidadCliente.ClienteId })
    ...
    $scope.GuardarSolicitud = function () {
        ...
        if ($scope.ValidarGeo() && $scope.ValidarDatosAdministrativos()){
            $http.post('/afiliaciones/GuardarSolicitud', { Solicitud: $scope.data.solicitudDigitalizada })
               .then(function (response) {
                   if (response.data.Success == true) {
    ...
    $scope.validarCuitServicio = function (Cuit, mostrarMensaje) {
        ...
        $http.post('/afiliaciones/ValidateCUIT', { cuit: Cuit, clienteId: ClienteId })
        .then(function successCallback(response) {
            if (response.data.Success == true) {
                if (mostrarMensaje)
    ...
    $scope.Afiliar = function () {
        if ($scope.ValidarDatosAdministrativos())
        {
            ...
            $http.post('/afiliaciones/Afiliar', { pCli: $scope.data.solicitudDigitalizada.EntidadCliente.ClienteId, pEmail: email })
            .then(function (response) {
